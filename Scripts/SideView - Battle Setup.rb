   ...
   #--------------------------------------------------------------------------
    ...
    def weapon_action 
      ...
      when 1 # Armas cortantes
        return "Slash Attack"
      when 4,5,7,9,12,13,14,15,16 # Armas cortantes
        return "Slash Attack"
      when 2
        return "Fist Attack"
      when 3
      ...
      when 11,21
        return "Rifle" #Rifles
      when 10,20
        return "Shot" #Pistolas y armas con municion
      when 17 
      ...
      when 19
        return "Rckt" # Misiles
      when 8
        return "Hamr" #Martillos Gigantes
      end
    end
    #--------------------------------------------------------------------------
    ...
    def enemy_weapon1_id 
      ...
      when -14 #Rhysorog
        return 65 
      when -15 #Stonebot Magnum
        return 73 
      when -16 #Stonebot Vaca
        return 74 
      when -17 #Stonebot Pala
        return 76 
      when -18 #Huitilo
        return 78 
      when -19 #Carchatilo
      ...
      when -22 #Guacitarra
        return 75 
      when -23 #Bandido Musaraña
        return 69 
      when -24 #Forajido Musaraña
        return 66 
      when -25 #Sangrenegra
        return 70 
      when -26 #Cavalkuju
    ...
    def skill_action
      ...
      when 31 # Ventisca Oscilante
        return "Impulso"
      when 32 # Bloque Pulido
        return "IceBlock Throw"
      #---HUTCH
      when 40 # Lazo Atadura
        return "Rope Bind"
      when 41 # Curacion Natural
        return "Depletion Magic"
      when 42 # Impacto Rocoso
        return "Boulder Throw"
      when 43 # Taladro Perforador
        return "Destrozaladro"
      ...
      when 196 #Pisoton Paleoceno
        return "Salto Pesado"
      when 200 #Puño Reverso
        return "Directo"
      when 201 #Gancho Picudo
        return "Derribo"
      when 202 #Ciclon Arenisco
        return "Directo"
      when 204 #Espora Absorbente
        return "Directo"
      when 206 #Garra Bestial
        return "Derribo"
      when 211 #Protocolo Pala
        return "Salto"
      when 212 #Protocolo Corrida
        return "Protocolo Corrida"
      when 215 #Protocolo Demoledor
        return "Placaje"
      when 216 #Ciclon Arenisco
        return "Directo"
