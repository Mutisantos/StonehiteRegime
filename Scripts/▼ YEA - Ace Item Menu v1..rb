...
module YEA
  module ITEM
    ...
    # [:category,"Ingredient"], # Categorized by <category: string>
      [:key_item,  "Key Items"], # Shows all key items.
    # [     :all,       "All"], # Shows all usable items.
    ] # Do not remove this.
    ...
    WEAPON_TYPES =[
    # [  :symbol,   "Display"],
      [   :types,  "Weapon Types"], # Lists all of the individual weapon types.
    ...
    VOCAB_STATUS ={
      ...
      :mp_recover => "+ EP",      # Text used for MP Recovery.
      :tp_recover => "+ FP",      # Text used for TP Recovery.
      :tp_gain    => "+ PF",      # Text used for TP Gain.
