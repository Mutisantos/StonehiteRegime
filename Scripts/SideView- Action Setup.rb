...
module N03
  ...
  FULLACTION = {
    ...
    "Victory Small Pose" => ["Erase Battle Anim", "Front Rotate", "Small Jump", "Small Jump", "Small Jump", "Small Jump", "Small Jump", "120"],
    ...
    "Derrape" => ["Skill Motion", "One Step Before Jump", "Timed Charge Bar 4x20", "Afterimage ON", "se('smrpg_enemy_fastmovement',100)", "Move near Enemy", "BolaNieve", "One Step After Jump", "Afterimage OFF", "Coordinate Reset Left"],
    ...
    "NadoRapido" => ["Don't Collapse", "Skill Motion", "One Step After Jump", "Timed Charge Bar XY", "Rotar 90", "SwiftNado", "Move to Enemy", "Rotar -90", "One Step After Jump", "One Step After Move", "Collapse", "Coordinate Reset Left"],
